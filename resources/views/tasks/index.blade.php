...
<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Tasks" buttonName="Create Task" modalHeaderText="New Task" modalView="tasks.modal-create"
                       dataBsTarget="kt_modal_create_task"/>
    </x-slot>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#tasksTable').on('click', '.editTaskButton', function () {
